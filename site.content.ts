...
/**
 * The homepage structure: which sections appear, in what order, and every
 * string they render. The components under `src/components/` stay untouched
 * when re-theming — this file (and, in the upcoming preset model, a file under
 * `presets/`) is the only source of structure. Type-checked at build time.
 *
 ...
 * `navLabel` is the menu entry (omit it to keep a section off the menu).
 *
 * The copy below is the worked example — a seasonal swimming-pool venue.
  ...
  sections: [
    ...
    },
    {
      ...
      data: {
        ...
        images: [
          { src: '/placeholder/image.svg', alt: 'Drink al bar' },
          { src: '/placeholder/image.svg', alt: 'Snack' },
          { src: '/placeholder/image.svg', alt: 'Solarium terrazza', wide: true },
        ],
      },
    },
  ],
