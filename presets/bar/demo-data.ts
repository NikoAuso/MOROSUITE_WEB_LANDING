...
/** Payload demo del preset "bar" (DEMO_MODE=true). Tipizzati contro i DTO. */

const SITE: SitePayload = {
  slug: 'demo',
  name: 'Caffè Demo',
  short_name: 'Caffè',
  tagline: 'Colazioni, aperitivi e cocktail dal vivo, dal mattino a mezzanotte.',
  default_locale: 'it',
  ...
  links: {
    booking: { label: 'Ordina al tavolo', url: 'https://app.example.com/prenota' },
  ...
  daily_hours: [
    {
      ...
      closed: false,
      intervals: [
        { slot: 'morning', label: 'Mattina', open: '06:00', close: '12:00' },
        { slot: 'evening', label: 'Sera', open: '17:00', close: '24:00' },
      ],
    },
    {
      key: 'tuesday',
